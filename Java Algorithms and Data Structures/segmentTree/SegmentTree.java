 ...
 * @modified: Implementation of  a dynamic RMQ with interval query and update. The update
 * adds a certain value to all cells in a given interval, while the query
 * returns the maximum value inside an interval.
 */
...
public class SegmentTree {
    ...
    /**
     * Creates a new segment tree with initial values given in values.
